...
public class ClienteController {
    ...
    @GetMapping(value = "/export", consumes = MediaType.ALL_VALUE, produces = "text/csv")
    public ResponseEntity<Object> export() throws IOException {
        log.info("Inicia consumo export");
        Object obj = clienteService.export();
